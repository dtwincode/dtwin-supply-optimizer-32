  ...
  return (
    <Card className="p-4">
      <div className="flex flex-col gap-4">
        ...
        <Alert>
          <AlertDescription>
            Model versions help you track changes in model configurations and compare their performance over time.
          </AlertDescription>
        </Alert>
            ...
            {selectedVersion && (
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <pre className="bg-muted p-4 rounded-md overflow-auto max-h-40">
                    {JSON.stringify(selectedVersion.validation_metrics, null, 2)}
                  </pre>
                </div>
              </div>
            )}
