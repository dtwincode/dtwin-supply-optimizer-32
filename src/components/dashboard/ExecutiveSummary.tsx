    ...
    <Card className="p-3">
      <div className="flex items-center justify-between mb-2">
        <h3 className="font-display text-md font-semibold flex items-center">
          ...
          {getTranslation("executiveSummary.title", language) ||
            "Executive Summary"}
        </h3>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
                  ...
                  <div>
                    ...
                    <div
                      className={`flex items-center text-xs ${
                        kpi.title.includes("stockoutRate") ||
                        kpi.title.includes("cycleTime")
                          ? kpi.trend === "down"
                            ? "text-green-500"
                            : "text-red-500"
                          : kpi.trend === "up"
        ...
        <div className="md:col-span-1">
          <Card className="p-2 h-full">
            <p className="text-xs font-medium mb-1">
              {getTranslation(
                "executiveSummary.bufferDistribution",
                language
              ) || "Buffer Distribution"}
            </p>
            <div className="h-24">
        ...
        <div className="md:col-span-1">
          <Card className="p-2 h-full">
            <p className="text-xs font-medium flex items-center mb-1">
              ...
              {getTranslation("executiveSummary.criticalAlerts", language) ||
                "Critical Alerts"}
            </p>
            {criticalAlerts.map((alert) => (
              <Alert
                key={alert.id}
                variant="destructive"
                className="py-1 px-2 mb-1 border-l-2 border-l-danger-400"
              >
                <AlertTitle className="text-xs font-medium">
                  ...
                  >
                    {getTranslation(
                      `executiveSummary.impact.${alert.impact}`,
                      language
                    ) || alert.impact}
                  </span>
                </AlertTitle>
                <AlertDescription className="text-xs">
                  {getTranslation(alert.description, language) ||
                    alert.description}
                </AlertDescription>
              </Alert>
            ))}
        ...
        <div className="md:col-span-2">
          <Card className="p-2">
            <p className="text-xs font-medium mb-1">
              {getTranslation("executiveSummary.performanceTrend", language) ||
              ...
              <ResponsiveContainer width="100%" height="100%">
                ...
                >
                  ...
                  <Line
                    ...
                    name={
                      getTranslation(
                        "executiveSummary.charts.actual",
                        language
                      ) || "Actual"
                    }
                  />
                  <Line
                    ...
                    name={
                      getTranslation(
                        "executiveSummary.charts.target",
                        language
                      ) || "Target"
                    }
                    strokeWidth={2}
        ...
        <div className="md:col-span-2">
          <Card className="p-2">
            <p className="text-xs font-medium flex items-center mb-1">
              ...
              {getTranslation("executiveSummary.moduleHealth", language) ||
                "Module Health"}
            </p>
              ...
              {moduleHealth.map((module) => (
                ...
                >
                  <div
                    ...
                    ${module.status === "healthy" ? "bg-green-500" : "bg-amber-500"}`}
                  ></div>
                  <span className="flex-1">
                    {getTranslation(`navigation.${module.name}`, language)}
                  </span>
                </div>
              ))}
            </div>
