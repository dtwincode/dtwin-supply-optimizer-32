...
import { Home, TrendingUp, Package, LineChart, Layers, Truck, FileText, Search, Database, BookOpen, ShoppingCart, Gift, BadgeCheck, Settings, AlertTriangle, Activity, Clock } from "lucide-react";
...
const navigationItems = [{
  ...
  name: "navigation.ddsop",
  icon: Layers,
  href: "/ddsop"
}, {
  name: "navigation.forecasting",
  icon: TrendingUp,
  href: "/forecasting"
}, {
...
const Navigation = memo(({
  ...
  return <nav className="py-2 space-y-0.5 h-[calc(100vh-4rem)] overflow-y-auto scrollbar-none">
