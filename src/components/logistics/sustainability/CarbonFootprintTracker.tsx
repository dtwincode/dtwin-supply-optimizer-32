      ...
      <CardHeader className="pb-2">
        <div className="flex flex-wrap justify-between items-center">
          <div className="flex items-center space-x-2">
            ...
            <CardTitle className="text-xl">{t("carbonFootprint")}</CardTitle>
          </div>
          <div className="flex items-center space-x-2">
                  ...
                  <div key={transport.name} className="mb-4">
                    <div className="flex justify-between mb-1">
                      ...
                      <span className="text-sm font-medium">
                        {transport.co2.toLocaleString()} kg
                      </span>
                    </div>
                ...
                <div className="border rounded-lg p-4">
                  ...
                  <ul className="space-y-2 mt-3">
                    <li className="flex items-center">
                      ...
                      <span className="text-sm">{t("switchToRail")}</span>
                    </li>
                    <li className="flex items-center">
                      <ArrowRight className="h-4 w-4 text-green-500 mr-2" />
                      <span className="text-sm">{t("optimizeRoutes")}</span>
                    </li>
                    <li className="flex items-center">
                      <ArrowRight className="h-4 w-4 text-green-500 mr-2" />
                      <span className="text-sm">{t("useEVs")}</span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="border rounded-lg p-4">
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-2.5 mt-2">
                    <div
                      className="bg-green-600 h-2.5 rounded-full"
                      style={{
                        width: `${Math.min(100, Math.round((totalCO2 / 14000) * 100))}%`,
                      }}
                    ></div>
                  </div>
          ...
          <TabsContent value="efficiency" className="pt-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <Card>
                <CardContent className="pt-6">
                  <div className="text-center">
                    <p className="text-sm text-gray-500">{t("co2PerKm")}</p>
              ...
              <Card>
                <CardContent className="pt-6">
                  <div className="text-center">
                    <p className="text-sm text-gray-500">{t("carbonOffset")}</p>
