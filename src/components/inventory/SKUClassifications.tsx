            ...
            <div className="flex-1">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-2">
                  ...
                  <Tooltip delayDuration={300} content={getClassificationTooltip('leadTime', item.classification.leadTimeCategory)}>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Tooltip delayDuration={300} content={getClassificationTooltip('variability', item.classification.variabilityLevel)}>
                    <Info className="h-4 w-4 text-gray-400" />
                  </Tooltip>
                </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Tooltip delayDuration={300} content={getClassificationTooltip('criticality', item.classification.criticality)}>
                    <Info className="h-4 w-4 text-gray-400" />
                  </Tooltip>
                </div>
              </div>
