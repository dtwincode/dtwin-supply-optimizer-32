...
export const DecouplingNetworkBoard: React.FC<DecouplingNetworkBoardProps> = ({ network }) => {
  return (
    <div className="border rounded-md p-4 bg-white h-[500px] overflow-auto">
      <h3 className="text-lg font-medium mb-4">Decoupling Network Visualization</h3>
      
      {/* Simplified network representation for now */}
      <div className="grid grid-cols-1 gap-4">
        <div>
          <h4 className="font-medium mb-2">Nodes ({network.nodes.length})</h4>
        ...
        <div>
          <h4 className="font-medium mb-2">Links ({network.links.length})</h4>
          <ul className="space-y-2">
